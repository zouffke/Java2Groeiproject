...
public class Sailboat implements Comparable<Sailboat>, Serializable {
     ...
     * @see Classification
     */
    Sailboat(String name, String harbour, double depth, int length, Classification classification, LocalDate buildYear) {
        setName(name);
        setHarbour(harbour);
        setDepth(depth);
        setLength(length);
     ...
     * @see Classification
     */
    Sailboat(String name, double depth, int length, Classification classification, LocalDate buildYear) {
     ...
     * @see Classification
     */
    Sailboat(String name, Classification classification, LocalDate buildYear) {
